 ...
 * @returns 
 */
export default async function encrypt(password, proxy = null) {
    var options = {
        ...
        headers: {
            ...
            Host: `m.cultureland.co.kr`,
            Referer: `https://m.cultureland.co.kr/`,
    ...
    var initTime = await axios.get('https://m.cultureland.co.kr?op=getInitTime', options).then((res) => res.data.match(/(?<=var initTime=')(.*?)(?=';)/)[0]).catch(() => '');
    ...
    var keyIndex = await axios.post('https://m.cultureland.co.kr/transkeyServlet', new URLSearchParams({
        op: 'getKeyIndex',
        name: 'password',
        keyboardType: 'number',
        initTime
    ...
    // @ts-ignore
    var dummy = await axios.post('https://m.cultureland.co.kr/transkeyServlet', new URLSearchParams({
        op: 'getDummy',
        keyboardType: 'number',
        fieldType: 'password',
        keyIndex,
